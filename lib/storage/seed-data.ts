...
export const seedStaff: Staff[] = [
  {
    ...
    roomAssignments: ['room-1', 'room-2'],
    specializations: ['deep-tissue', 'sports-massage', 'aromatherapy'],
    status: 'active',
  ...
  },
  {
    ...
    roomAssignments: ['room-3'],
    specializations: ['swedish-massage', 'hot-stone', 'reflexology'],
    status: 'active',
  ...
  },
  {
    ...
    roomAssignments: ['room-4'],
    specializations: ['consultation', 'nutrition', 'lifestyle-coaching'],
    status: 'active',
  ...
  },
  {
    ...
    role: 'Spa Therapist',
    roomAssignments: ['room-5'],
    specializations: ['facial', 'body-treatments', 'aromatherapy'],
    status: 'active',
  ...
  },
  {
    ...
    role: 'Hair Stylist',
    roomAssignments: ['room-7'],
    specializations: ['cutting', 'coloring', 'styling'],
    status: 'active',
...
export const seedRooms: Room[] = [
  {
    ...
    amenities: ['massage-table', 'aromatherapy', 'sound-system', 'dimming-lights'],
    status: 'active',
    createdAt: '2023-01-15T10:00:00Z',
    updatedAt: '2024-01-15T10:00:00Z',
  },
  {
    ...
    amenities: ['massage-table', 'hot-stone-warmer', 'towel-warmer', 'sound-system'],
    status: 'active',
    createdAt: '2023-01-15T10:00:00Z',
    updatedAt: '2024-01-15T10:00:00Z',
  },
  {
    ...
    amenities: ['massage-table', 'storage', 'sink'],
    status: 'active',
    createdAt: '2023-01-15T10:00:00Z',
    updatedAt: '2024-01-15T10:00:00Z',
  },
  {
    ...
    amenities: ['desk', 'chairs', 'computer', 'whiteboard'],
    status: 'active',
    createdAt: '2023-01-15T10:00:00Z',
    updatedAt: '2024-01-15T10:00:00Z',
  },
  {
    ...
    amenities: ['massage-table', 'jacuzzi', 'sauna', 'shower', 'relaxation-area'],
    status: 'active',
    createdAt: '2023-03-10T10:00:00Z',
    updatedAt: '2024-01-15T10:00:00Z',
  },
  {
    ...
    amenities: ['massage-table', 'storage'],
    status: 'active',
    createdAt: '2023-03-10T10:00:00Z',
    updatedAt: '2024-01-15T10:00:00Z',
  },
  {
    ...
    amenities: ['styling-chair', 'mirror', 'sink', 'hair-dryer'],
    status: 'active',
    createdAt: '2023-06-20T10:00:00Z',
    updatedAt: '2024-01-10T10:00:00Z',
  },
...
export const seedServices: Service[] = [
  {
    ...
    price: 120,
    category: 'massage',
    requirements: ['licensed-therapist'],
    status: 'active',
    createdAt: '2023-01-15T10:00:00Z',
    updatedAt: '2024-01-15T10:00:00Z',
  },
  ...
  },
  {
    ...
    price: 150,
    category: 'massage',
    requirements: ['hot-stone-equipment'],
    status: 'active',
    createdAt: '2023-01-15T10:00:00Z',
    updatedAt: '2024-01-15T10:00:00Z',
  },
