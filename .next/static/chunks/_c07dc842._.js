...
"[project]/services/mockApi.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
let guestStore = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockGuests"]
];
let checkInStore = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockCheckIns"]
];
let registrationStore = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockRegistrations"]
];
let hospitalityStore = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockHospitality"]
];
let venueStore = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockVenues"]
];
let eventStore = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockEvents"]
];
let staffStore = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockStaff"]
];
let notificationStore = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockNotifications"]
];
// Filter and pagination helper
function paginate(data) {
    let filters = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, searchFields = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [];
    let filtered = [
        ...data
    ];
    // Search filter
...
class MockApiService {
    ...
    async createGuest(guestData) {
        ...
        try {
            const newGuest = {
                ...
                checkedIn: false,
                qrCode: "QR".concat(generateId().toUpperCase())
            };
            guestStore.push(newGuest);
            // Create notification
            this.addNotification({
                title: 'New Guest Added',
                message: "".concat(newGuest.name, " has been registered"),
                type: 'info'
            });
            return {
                success: true,
    ...
    async deleteGuest(id) {
        ...
        this.addNotification({
            title: 'Guest Removed',
            message: "".concat(guest.name, " has been removed from the system"),
            type: 'warning'
        });
        return {
            success: true
    ...
    async bulkImportGuests(file) {
        ...
        this.addNotification({
            ...
            message: "".concat(mockImportedCount, " guests imported successfully"),
            type: 'success'
        });
        return {
            success: true,
    ...
    async exportGuests() {
        ...
        await delay(1000);
        // Mock export URL
        const downloadUrl = "/api/exports/guests_".concat(Date.now(), ".").concat(format);
        return {
            success: true,
            data: {
                downloadUrl
    ...
    async createCheckIn(checkInData) {
        ...
        try {
            ...
            this.addNotification({
                ...
                message: "".concat(checkInData.guestName, " has checked in"),
                type: 'success'
            });
            return {
                success: true,
    ...
    async printBadge(checkInId) {
        ...
        this.addNotification({
            title: 'Badge Printed',
            message: "Badge printed for ".concat(checkInStore[checkInIndex].guestName),
            type: 'info'
        });
        return {
            success: true,
    ...
    async createRegistration(regData) {
        ...
        try {
            ...
            this.addNotification({
                ...
                message: "".concat(regData.guestName, " registered for ").concat(regData.event),
                type: 'info'
            });
            return {
                success: true,
    ...
    async deleteRegistration(id) {
        ...
        this.addNotification({
            ...
            message: "Registration for ".concat(registration.guestName, " has been cancelled"),
            type: 'warning'
        });
        return {
            success: true
    ...
    async confirmRegistration(id) {
        ...
        this.addNotification({
            ...
            message: "Registration for ".concat(registrationStore[index].guestName, " has been confirmed"),
            type: 'success'
        });
        return {
            success: true,
    ...
    async updatePaymentStatus(id, status) {
        ...
        this.addNotification({
            ...
            message: "Payment status updated to ".concat(status, " for ").concat(registrationStore[index].guestName),
    ...
    async createHospitality(hospData) {
        ...
        try {
            ...
            this.addNotification({
                ...
                message: "".concat(hospData.type, " booked for ").concat(hospData.guestName),
                type: 'info'
            });
            return {
                success: true,
    ...
    async deleteHospitality(id) {
        ...
        this.addNotification({
            ...
            message: "".concat(hospitality.type, " booking cancelled for ").concat(hospitality.guestName),
            type: 'warning'
        });
        return {
            success: true
    ...
    async createVenue(venueData) {
        ...
        try {
            ...
            this.addNotification({
                ...
                message: "".concat(newVenue.name, " has been added to the system"),
                type: 'success'
            });
            return {
                success: true,
    ...
    async deleteVenue(id) {
        ...
        this.addNotification({
            title: 'Venue Removed',
            message: "".concat(venue.name, " has been removed from the system"),
            type: 'warning'
        });
        return {
            success: true
    ...
    async updateVenueOccupancy(id, occupancy) {
        ...
        if (occupancyPercent >= 90) {
            this.addNotification({
                ...
                message: "".concat(venue.name, " is at ").concat(occupancyPercent.toFixed(0), "% capacity"),
                type: 'warning'
            });
        }
        return {
    ...
    async createEvent(eventData) {
        ...
        try {
            ...
            this.addNotification({
                ...
                message: "".concat(newEvent.title, " has been scheduled"),
                type: 'success'
            });
            return {
                success: true,
    ...
    async deleteEvent(id) {
        ...
        this.addNotification({
            ...
            message: "".concat(event.title, " has been cancelled"),
            type: 'error'
        });
        return {
            success: true
    ...
    async createStaff(staffData) {
        ...
        try {
            ...
            this.addNotification({
                ...
                message: "".concat(newStaff.name, " has joined the team"),
                type: 'success'
            });
            return {
                success: true,
    ...
    async deleteStaff(id) {
        ...
        this.addNotification({
            title: 'Staff Removed',
            message: "".concat(staff.name, " has been removed from the team"),
            type: 'warning'
        });
        return {
            success: true
    ...
    async getActivityFeed() {
        ...
        const sortedActivities = [
            ...__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockActivityFeed"]
    ...
    async getChartData(type) {
        ...
        switch(type){
            ...
            case 'venue-utilization':
                data = __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockVenueUtilization"];
                break;
            case 'monthly-stats':
                data = __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockMonthlyStats"];
                break;
            default:
                return {
                    success: false,
    ...
    async generateReport(type) {
        let format = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 'PDF', filters = arguments.length > 2 ? arguments[2] : void 0;
        await delay(2000); // Simulate report generation time
        const reportId = "report_".concat(generateId());
        this.addNotification({
            title: 'Report Generated',
            message: "".concat(type.charAt(0).toUpperCase() + type.slice(1), " report (").concat(format, ") is ready for download"),
            type: 'success'
        });
        return {
            success: true,
    ...
    async downloadReport(id) {
        await delay();
        const downloadUrl = "/api/reports/".concat(id, "/download?token=").concat(generateId());
        return {
            success: true,
            data: {
                downloadUrl
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/mockApi.ts [app-client] (ecmascript)");
;
class WorkflowService {
   ...
   */ async completeRegistration(data) {
        try {
            ...
            const existingGuestsResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].getGuests({
                search: data.email,
                pageSize: 1
            });
            let guest;
            if (existingGuestsResponse.success && existingGuestsResponse.data.data.length > 0) {
                ...
                const updateResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].updateGuest(existingGuest.id, {
                    name: data.guestName,
                    phone: data.phone,
                ...
                // Create new guest
                const guestResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].createGuest({
                    name: data.guestName,
                    email: data.email,
                    phone: data.phone,
                    company: data.company,
            ...
            const registrationResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].createRegistration({
            ...
            if (data.hospitalityRequests && data.hospitalityRequests.length > 0) {
                for (const request of data.hospitalityRequests){
                    const hospResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].createHospitality({
                        guestId: guest.id,
                        guestName: guest.name,
                        type: request.type,
   ...
   */ async processCheckIn(data) {
        try {
            ...
            if (data.method === 'QR' && data.qrCode) {
                checkInResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].checkInByQr(data.qrCode, data.venue);
            } else if (data.guestId) {
                checkInResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].checkInGuest(data.guestId, data.method, data.venue);
            } else {
                return {
                    success: false,
            ...
            const guestResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].getGuest(checkIn.guestId);
            if (!guestResponse.success) {
                return {
                    success: false,
            ...
            if (data.printBadge) {
                const badgeResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].printBadge(checkIn.id);
   ...
   */ async createEventWithVenue(eventData) {
        try {
            ...
            const venueResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].getVenue(eventData.venueId);
            ...
            // Create event
            const eventResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].createEvent({
                ...eventData,
                attendees: 0,
                status: 'active'
            });
   ...
   */ async bulkCheckIn(guestIds, venue) {
        ...
        for (const guestId of guestIds){
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].checkInGuest(guestId, method, venue);
            if (result.success) {
   ...
   */ async bulkConfirmRegistrations(registrationIds) {
        ...
        for (const regId of registrationIds){
            const confirmResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].confirmRegistration(regId);
            if (confirmResponse.success) {
                // Also mark payment as paid
                const paymentResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].updatePaymentStatus(regId, 'paid');
   ...
   */ async createHospitalityPackage(guestId, packageType, customServices) {
        try {
            ...
            const guestResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].getGuest(guestId);
            if (!guestResponse.success) {
                return {
                    success: false,
                    error: 'Guest not found'
   ...
   */ async getGuestJourney(guestId) {
        try {
            ...
            const [registrationsRes, checkInsRes, hospitalityRes] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].getRegistrations({
                    search: guest.email
                }),
                __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].getCheckIns({
                    search: guest.email
                }),
                __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].getGuestHospitality(guestId)
            ]);
            ...
            const eventsResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].getEvents();
   ...
   */ async generateEventReport(eventId) {
        try {
            // Get event details
            const eventResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].getEvent(eventId);
            if (!eventResponse.success) {
                return {
                    success: false,
                    error: 'Event not found'
            ...
            const registrationsResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].getRegistrations();
            ...
            const checkInsResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].getCheckIns();
   ...
   */ async getVenueUtilizationReport() {
        try {
            const venuesResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mockApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockApiService"].getVenues();
...
function CompleteRegistrationDialog(param) {
    ...
    const handleSubmit = async (e)=>{
        ...
        if (result.success) {
            toast({
                title: 'Registered!',
                description: "".concat(form.guestName, " registered for ").concat(form.eventTitle, ".")
            });
            onOpenChange(false);
            setForm(EMPTY_FORM);
        } else {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogFooter"], {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                    type: "submit",
                                    disabled: loading || !form.guestName.trim() || !form.email.trim() || !form.eventTitle.trim(),
                                    children: loading ? 'Saving…' : 'Register'
                                }, void 0, false, {
                                    fileName: "[project]/components/dialogs/CompleteRegistrationDialog.tsx",
                                    lineNumber: 107,
                                    columnNumber: 13
...
_s(CompleteRegistrationDialog, "Hi3V8/rH7Cb/PIHxpcsu1gqDxjc=", false, function() {
    return [
...
function RegistrationsPage() {
    ...
    // customers state
    const [customers, setCustomers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockCustomers"]);
    ...
    // registrations state
    const [regDialogOpen, setRegDialogOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const filteredCustomers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RegistrationsPage.useMemo[filteredCustomers]": ()=>{
            return customers.filter({
                "RegistrationsPage.useMemo[filteredCustomers]": (c)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                ...
                                children: "Registrations & Customers"
                            }, void 0, false, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-sm text-muted-foreground",
                                children: "Manage guests, memberships and event registrations"
                            }, void 0, false, {
                                fileName: "[project]/app/(dashboard)/registrations/page.tsx",
                                lineNumber: 87,
                                columnNumber: 11
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    'registrations'
                        ...
                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('px-4 py-2 text-sm font-medium capitalize transition-colors border-b-2 -mb-px', activeTab === tab ? 'border-primary text-primary' : 'border-transparent text-muted-foreground hover:text-foreground'),
                        children: tab
                    }, tab, false, {
                        fileName: "[project]/app/(dashboard)/registrations/page.tsx",
                        lineNumber: 105,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Table"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableBody"], {
                                    children: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockRegistrations"].map((reg)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            addCustomerOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AddCustomerDialog, {
...
_s(RegistrationsPage, "GDoZXymvZ/epwJ4sOzGCxk3i1PM=", false, function() {
    return [
...
//# sourceMappingURL=_c07dc842._.js.map