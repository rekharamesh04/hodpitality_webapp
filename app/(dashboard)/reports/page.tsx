...
import {
  RefreshCw, Download, FileText, UserCheck, DoorOpen, Clock, Hotel, Percent, Users, CalendarDays, ShieldCheck, History,
} from 'lucide-react';
...
function ReportsPageInner() {
  ...
  function handleExport() {
    ...
    exportToCSV(
      ...
      `dashboard-report-${toLocalDateInput()}`
    );
  }
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button size="sm" variant="outline" onClick={handleExport} disabled={!stats}>
      ...
      {isError ? (
        ...
        <>
          ...
          <section aria-labelledby="reports-performance-heading" className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Every tracked operational metric</CardDescription>
            </CardHeader>
...
function RevenueTrendWidget() {
  ...
  return (
    <AreaChartComponent
      title="Revenue Trend"
      description="Paid revenue over the last 30 days"
      data={normalizedData}
      dataKey="revenue"
      xAxisKey="date"
      height={300}
